...
async def list_courses(
    ...
    technology: Optional[str] = Query(default=None, description="Technology tag filter"),
    search: Optional[str] = Query(default=None, description="Search term across title, description, and technologies"),
    certificate_available: Optional[bool] = Query(default=None, description="Filter courses with certification vouchers"),
