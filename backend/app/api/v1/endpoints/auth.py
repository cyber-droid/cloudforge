...
async def refresh_token(
    ...
    return await auth_service.refresh_access_token(db, refresh_token_str=data.refresh_token)
...
async def logout(
    ...
    await auth_service.logout(db, refresh_token_str=refresh_token_str, user=current_user)
